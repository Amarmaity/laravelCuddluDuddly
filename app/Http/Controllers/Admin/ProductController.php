...
class ProductController extends Controller
{
    ...
    //         'stock' => 'required|integer|min:0',
    //         'description' => 'nullable|string',
    //         'images.*' => 'nullable|image|mimes:jpeg,jpg,png|max:500', // optional but limited
    ...
    //         // 🗑️ Handle image deletions
    //         if (!empty($validated['removed_images'])) {
    //             $imagesToDelete = ProductImage::whereIn('id', $validated['removed_images'])
    ...
    //         // 🧩 Update category-section mapping
    ...
    //         // 🧮 Ensure minimum 3 images exist after update
    //         $finalImageCount = $product->images()->count();
